        ...
        <div className="contact-container pt-16 bg-linear-to-br from-[#2c5aa0] to-[#1e3a6f] min-h-screen py-16 px-4">
            ...
            <div className="max-w-2xl mx-auto bg-white rounded-2xl shadow-2xl p-8 md:p-12">
                <form className="space-y-6">
                    ...
                    <button 
                        type="submit"
                        className="w-full bg-[#2563eb] hover:bg-[#1e40af] text-white font-semibold py-3 px-6 rounded-lg transition duration-200 transform hover:scale-105 active:scale-95 shadow-lg"
                    >
                        Enviar mensaje
                    </button>
                </form>
